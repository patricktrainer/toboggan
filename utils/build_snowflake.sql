...
AUTO_SUSPEND = 60
AUTO_RESUME = TRUE
COMMENT = "This is the warehouse that dbt will use to perform all data transformations"
;
-- This is the warehouse that dbt will use to perform all data transformations.
